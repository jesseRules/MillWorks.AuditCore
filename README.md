...
| `SecurityEvents` | Security-relevant events, tamper/compliance alerts, and break-glass access records | `Id`, `EventType`, `Severity`, `Message`, `DetailsJson`, `IpAddress`, `DetectedAt`, `CorrelationId`, `TenantId`, `ActorUserId`, `SubjectUserId`, `SourceIpHash`, `UserAgentHash`, `Operation` |
